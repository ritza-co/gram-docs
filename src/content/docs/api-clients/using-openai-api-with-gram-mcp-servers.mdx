---
title: "Using OpenAI's Responses API with Gram-hosted MCP servers"
...
- **Responses API** (this guide): Simple request-response pattern, ideal for basic tool calling and quick integrations
- **[Agents SDK](/api-clients/using-openai-agents-sdk-with-gram-mcp-servers)**: Advanced agent framework with sessions, handoffs, and persistent context, perfect for complex conversational workflows

If you need more advanced features like persistent conversations or complex workflows, consider the [Agents SDK guide](/api-clients/using-openai-agents-sdk-with-gram-mcp-servers).
