...
```bash
claude mcp add taskmaster --scope project --env MCP_TASK_MASTER_API_KEY=your-api-key -- npx mcp-remote https://app.getgram.ai/mcp/your-taskmaster-slug --header "MCP-TASK-MASTER-API-KEY:${MCP_TASK_MASTER_API_KEY}"
```
...
```bash
claude mcp add taskmaster --scope project --env GRAM_KEY=your-gram-api-key -- npx mcp-remote https://app.getgram.ai/mcp/your-taskmaster-slug --header "Authorization: ${GRAM_KEY}"
```
