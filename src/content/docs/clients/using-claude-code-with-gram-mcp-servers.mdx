...
- If you're using the **Pass-through Authentication** configuration, the JSON configuration looks like this:
    ...
    So you can add the server by running the following command (replace `<your-api-key>` with the actual values from your Taskmaster MCP server configuration and `your-taskmaster-slug` with your MCP server slug):
...
- Whereas if you're using the **Managed Authentication** configuration, the JSON configuration looks like this:
    ...
    So you can add the server by running the following command (replace `<your-gram-api-key>` with your actual Gram API key and `your-taskmaster-slug` with your MCP server slug):
