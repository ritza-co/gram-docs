...
- **URL:** The URL of your Gram-hosted MCP server (e.g., `https://app.getgram.ai/mcp/your-taskmaster-slug`).
...
Claude should prompt you with a tool call request. This means the connection is working, and Claude can now use your Gram-hosted MCP server to access the Taskmaster API.
