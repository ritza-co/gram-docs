...
Add your Taskmaster MCP server configuration. For a public server:
...
Ask Cline a basic question like, "Can you create a new task called 'Test MCP connection'?"
...
Cline will use the `createTask` tool to create a new task. Before making the API call, it will ask for your permission to use the tool:
