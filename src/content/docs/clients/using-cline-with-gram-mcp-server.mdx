...
You need an API key to use an authenticated server. [Generate an API key](/concepts/api-keys) in the Gram **Settings** tab and replace `<your-key-here>` with your actual Gram API key.
