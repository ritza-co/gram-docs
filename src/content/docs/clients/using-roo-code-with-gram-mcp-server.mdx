...
Add your Taskmaster MCP server configuration from the [Creating a Taskmaster MCP server](/build-mcp/creating-taskmaster-mcp-server) guide. If you're using a public server, add the following to the `mcp_settings.json` file:
